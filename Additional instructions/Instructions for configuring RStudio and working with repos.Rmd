...
2. **ONLY IF YOU ARE NOT SURE THAT Git IS INSTALLED ON YOUR LAPTOP**: On you personal computer/laptop, open RStudio, and follow the instructions in Chapter 6 of Happy Git and GitHub for the useR: https://happygitwithr.com/install-git.html 
...
```
  ...
  4D. Click Generate Token. COPY DOWN THIS TOKEN SOMEWHERE SAFE, LIKE NOTEPAD. GITHUB WILL NEVER GIVE IT TO YOU AGAIN. 
